...
plot_col_names = ['Potassium'] #['Potassium', 'Phosphorus']

orig_name = sys.argv[1]         
orig_scaled_name = sys.argv[2]   #don't need this if not using scaling
...
prop_delta_array = true_delta_array
...
#each plot ccolumn index
    ...
    plt.contourf(xi, yi, R, vmin=-30, vmax=30, cmap='coolwarm')   #vmax = maxrange
    plt.colorbar()
